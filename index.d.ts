...
declare class TRTC {
    ...
    static login(
        options: { sdkAppId: number, userId: string, userSig: string }
    ): void

    static logout(): void

    static call(options: { userId: string; callType: number }): void
    ...
    static setHandsFree(isHandsFree: boolean): void
